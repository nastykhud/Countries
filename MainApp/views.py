...
def country(request, country):
    cons = []
    for co in clist:
        cons.append(co['country'])
    if (country in cons): #если нужная страна в списке
        context = {'country': clist[cons.index(country)]}
